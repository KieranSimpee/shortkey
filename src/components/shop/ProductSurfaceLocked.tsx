...
/**
 * Product / Shop surface locked — ratio & display under design review.
 * Do not expose unfinished product grids publicly.
 */
export function ProductSurfaceLocked({
  title = "Shop",
}: {
  title?: string;
}) {
  return (
    <main className="page-shell flex min-h-[70vh] flex-col items-center justify-center px-4 py-16 text-center sm:px-8">
      ...
      <p className="mx-auto mt-3 max-w-md text-sm leading-relaxed text-ink-muted">
        Product pages are locked while we fix display ratio and layout. Shop opens with
