...
|------|------|---------|--------|
| 2026-07-24 | Studio | **P0 · DNA Control Room** | `shortkey.studio` → `/internal/studio` · local **port 3003** (`npm run studio:dev` · `SHORTKEY_SURFACE=studio`). One DNA. Many doors. Hero · 8 DNA · Domain Map · Approved Copy · Build Order. Soft pearl/lilac · noindex · no backend/login/payment. Family Table stays on `family.shortkey.world` / :3002. Doc: [`SHORTKEY_STUDIO_P0_DNA_CONTROL.md`](./SHORTKEY_STUDIO_P0_DNA_CONTROL.md). Status: **Internal Staging · Gor Gor Review pending**. |
