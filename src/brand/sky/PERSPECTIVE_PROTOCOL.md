...
This is a **perspective** protocol — **not** a trust protocol.
...
| Lens | Ask |
|------|-----|
| **Reasoning** | Is the thinking clear and honest? |
| **Evidence** | What supports this view? |
| **User value** | Does it help the people we serve? |
| **Business impact** | Does it strengthen ShortKey / Simplex-ity outcomes? |
| **Alignment with principles** | Does it honor Family Commitment, equal respect, brand locks? |
...
## 2. Kieran Reflection Protocol

When a team member or AI proposes an alternative approach:

**Pause before correcting.**

Ask:

1. What do they see that I might not see?  
2. What audience are they considering?  
3. What assumption of mine are they challenging?  
...
## How this sits with existing locks

| Existing | Relationship |
|----------|----------------|
| Family Commitment (seven) | Unchanged — this protocol sits **beside** them |
...
## Operating cue (every seat)

Before dismissing another seat’s view:
