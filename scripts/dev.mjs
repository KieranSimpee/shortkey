...
const surface = isStudio ? "studio" : isFamily ? "family" : "shortkey";

// ShortKey :3001 · Family Table :3002 · Studio DNA Control Room :3003

const port =

  Number(process.env.PORT) || (isStudio ? 3003 : isFamily ? 3002 : 3001);
