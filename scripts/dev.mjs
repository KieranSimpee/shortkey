...
const surface = isFamily ? "family" : "shortkey";
// ShortKey locked to 3001; Family Table internal workbench on 3002.
const port = Number(process.env.PORT) || (isFamily ? 3002 : 3001);

const wasmDir = path.join(root, "node_modules", "@next", "swc-wasm-nodejs");
const HEALTH_MS = 25_000;
const HEALTH_TIMEOUT_MS = 8_000;
const FAIL_BEFORE_RESTART = 2;
const healthPath = isFamily ? "/internal/family-table" : "/";
